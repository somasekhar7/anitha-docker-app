  ...
  if (hasError) return; 
    ...
    return(
        <div>
            ...
            {isModal && (<div className="modal fade show" tabIndex="-1" role="dialog" style={{ display: 'block' }}>
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-danger" style={{ backgroundColor: 'orange',}} data-dismiss="modal" onClick={handleModalClose}>Close</button>
                            <button type="submit" className="btn btn-danger" style={{ backgroundColor: 'orange',}} onClick={handleAddItem}>Add</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        {isModale && (<div className="modal fade show" tabIndex="-1" role="dialog" style={{ display: 'block' }}>
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-body">
                            <form >
                                <div className="form-group">
                                <input type="text" className="form-control" name="updatedName" placeholder="Item Name" value={updatedItemName}   onChange={handleUpdateName} required />

                                    
                                </div>
                                <div className="form-group">
                                <input type="number" className="form-control" name="updatedNumber" placeholder="Quantity" value={updatedItemQuantity}  onChange={handleUpdateQuantity} required />
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-danger" style={{ backgroundColor: 'orange',}} onClick={()=>setIsModale(false)} data-dismiss="modal">Close</button>
                            <button type="submit" className="btn btn-danger" style={{ backgroundColor: 'orange',}} data-dismiss="modal" onClick={handleUpdateItem}>Edit</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-2 text-center">
                    <button className="btn btn-danger mr-3" style={{ backgroundColor: 'orange' ,marginRight: '8px' }} data-toggle="modal" data-target="#addItemModal" onClick={() => setIsModal(true)}>
                        ADD ITEM
                    </button>
                </div>
                <div class="col-2 text-center">
                    <button className="btn btn-danger mr-3" style={{ backgroundColor: 'orange' ,marginRight: '8px' }} onClick={handleRenderItems}>
                        VIEW ITEMS
                    </button>
                </div>
                <div class="col-4"></div>
                ...
                <div class="container mt-4">
                 ...
                 {inventoryItems.map((item) => (
                     <div className="col-md-4 mb-4" key={item._id}>
                         <div className="card">
                             {/* Item image */}
                             <img  src={item.imageUrl} className="card-img-top" alt={item.name} style={{ width: '150px', height: '150px', objectFit: 'cover' }} />
                             <div className="card-body">
                                 ...
                                 <div className="btn-group" role="group">
                                     <button type="button" className="btn btn-danger" style={{backgroundColor:"orange"}} onClick={() => handleUpdateButtonClick(item._id,item.name,item.quantity)}>Update</button>
                                     <button type="button" className="btn btn-danger" style={{backgroundColor:"orange"}} onClick={() => handleDeleteItem(item._id)}>Delete</button>
                                 </div>
                             </div>
                         </div>
                     </div>
